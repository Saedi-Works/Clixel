...
function clixel_customize_register( $wp_customize ) {
	require(get_template_directory() . '/inc/customizer/includes/control-toggle.php');
require(get_template_directory() . '/inc/customizer/includes/control-info.php');
require(get_template_directory() . '/inc/customizer/includes/control-editor.php');
require(get_template_directory() . '/inc/customizer/includes/control-multicheck.php');
require(get_template_directory() . '/inc/customizer/includes/control-radioimg.php');
require(get_template_directory() . '/inc/customizer/includes/helpers.php');
...
$wp_customize->remove_section( 'custom_css' );
   require(get_template_directory() . '/inc/customizer/controls/settings-basic.php');
require(get_template_directory() . '/inc/customizer/controls/settings-header.php');
require(get_template_directory() . '/inc/customizer/controls/settings-frontpage.php');
require(get_template_directory() . '/inc/customizer/controls/settings-postpage.php');
require(get_template_directory() . '/inc/customizer/controls/settings-footer.php');
require(get_template_directory() . '/inc/customizer/controls/settings-misc.php');
require(get_template_directory() . '/inc/customizer/controls/settings-code.php');
require(get_template_directory() . '/inc/customizer/controls/settings-help.php');
}
