...
var PATHS = {
  sass: [
    'assets/components/bootstrap/scss',
...
gulp.task('clean:css', function() {
  return del([
      'assets/css/clixel.css',
      'assets/css/clixel.css.map'
    ]);
});
...
gulp.task('default', ['build', 'browser-sync'], function() {
  ...
  // JS Watch
  gulp.watch(['assets/js/custom/**/*.js'], ['clean:javascript', 'javascript', 'lint'])
    .on('change', function(event) {
      logFileChange(event);
    });
});
